...
<img src="https://img.shields.io/badge/Project%20with-Beginner Friendly-3178C6?style=for-the-badge&logo=typescript&logoColor=white" />
...
To ensure fair contribution opportunities for everyone:

- contributors may work on only **ONE issue at a time**
- before claiming another issue, you must:
  - either finish your current assigned issue,
  - or leave/unassign the current issue first

Please avoid claiming multiple issues simultaneously.

---

## ⏳ Long Unfinished Issues

If an issue remains inactive or unfinished for a long period of time:

- maintainers may reopen it,
- unassign it,
- or allow another contributor to continue the work

This helps maintain healthy project progress and avoids contribution bottlenecks.
...
# 🤖 ML / AI Related Contributions

Currently, the project is **not heavily focusing on ML/AI integrations or experimental AI features**.
...
- and deeper technical planning.

However:

> 💡 Discussions, suggestions, architectural ideas, and feedback related to ML/AI are absolutely welcome.
...
- proposing ML/AI ideas,
- discussing feasibility,
- brainstorming healthcare AI applications,
- sharing research,
- or suggesting future directions.

We genuinely appreciate thoughtful technical discussions in this area ❤️
